...
class UI {
    ...
    imprimirAlerta(mensaje, tipo) {
        ...
        // Agrega el mensaje de la alerta
    ...
    imprimirCitas({citas}) {
        ...
        citas.forEach( cita => {
            ...
            // Crear el div que contendra los datos de la cita
...
function nuevaCita(e) {
    ...
    if(editando) {
        ...
        // Regresar estado del boton a su estado original
